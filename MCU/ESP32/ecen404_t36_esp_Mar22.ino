...
// notify changed value
  /*    spi_slave_rx_buf[0] = {0x11};
      spi_slave_rx_buf[1] = {0x02};
      spi_slave_rx_buf[2] = {0x03};
      spi_slave_rx_buf[3] = {0x04};
      spi_slave_rx_buf[4] = {0x05};
      spi_slave_rx_buf[5] = {0x06};
      spi_slave_rx_buf[6] = {0x07};
      spi_slave_rx_buf[7] = {0x08};
      spi_slave_rx_buf[8] = {0x09};
      spi_slave_rx_buf[9] = {0x10};
      spi_slave_rx_buf[10] = {0x11};
      spi_slave_rx_buf[11] = {0x12};
      spi_slave_rx_buf[12] = {0x13};
      spi_slave_rx_buf[13] = {0x14};
      spi_slave_rx_buf[14] = {0x15};
      spi_slave_rx_buf[15] = {0x16};
      spi_slave_rx_buf[15] = {0x17};
      spi_slave_rx_buf[16] = {0x18};
      spi_slave_rx_buf[17] = {0x19};
      spi_slave_rx_buf[18] = {0x20};
      spi_slave_rx_buf[19] = {0x21};
      spi_slave_rx_buf[20] = {0x22};
      spi_slave_rx_buf[21] = {0x23};
      spi_slave_rx_buf[22] = {0x24};
      spi_slave_rx_buf[23] = {0x25};
      spi_slave_rx_buf[24] = {0x26};
      spi_slave_rx_buf[25] = {0x27};
      spi_slave_rx_buf[26] = {0x28};
      spi_slave_rx_buf[27] = {0x29};
      spi_slave_rx_buf[28] = {0x30};
      spi_slave_rx_buf[29] = {0x31};
      spi_slave_rx_buf[30] = {0x32};
      spi_slave_rx_buf[31] = {0x33};*/
    if (deviceConnected) {
